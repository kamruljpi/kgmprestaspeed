<?php
class kgmprestaspeed extends Module {
	public function __construct() {
		$this->name = 'kgmprestaspeed';
		$this->tab = 'front_office_features';
		$this->version = '1.0.0';
		$this->author = 'mdkamrul.info';
		$this->bootstrap = true;
		parent::__construct();
		$this->displayName = $this->l('PrestaShop Speed Optimized Modules By Kamrulzzaman');
		$this->description = $this->l('PrestaShop Speed Optimized Modules By Kamrulzzaman. If you want to increase more speed performance Please conatct with me by email kamruljpi@gmail.com ');
	...
	public function hookdisplayFooter() {
		...
		if($minify_html_active){
			global $smarty;
			$smarty->registerFilter('output', array('kgmprestaspeed', 'minifyFullContent'));
		}
	}
